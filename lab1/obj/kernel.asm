...
void print_regs(struct pushregs *gpr) {
    ...
    802001a8:	b6450513          	addi	a0,a0,-1180 # 80200d08 <etext+0x292>
void print_regs(struct pushregs *gpr) {
    ...
    80200360:	c9450513          	addi	a0,a0,-876 # 80200ff0 <etext+0x57a>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200376:	c9650513          	addi	a0,a0,-874 # 80201008 <etext+0x592>
void print_trapframe(struct trapframe *tf) {
    ...
    802003c2:	caa50513          	addi	a0,a0,-854 # 80201068 <etext+0x5f2>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003f2:	8ca50513          	addi	a0,a0,-1846 # 80200cb8 <etext+0x242>
    802003f6:	c7dff06f          	j	80200072 <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003fa:	00001517          	auipc	a0,0x1
    802003fe:	89e50513          	addi	a0,a0,-1890 # 80200c98 <etext+0x222>
    80200402:	c71ff06f          	j	80200072 <cprintf>
            cprintf("User software interrupt\n");
    80200406:	00001517          	auipc	a0,0x1
    8020040a:	85250513          	addi	a0,a0,-1966 # 80200c58 <etext+0x1e2>
    8020040e:	c65ff06f          	j	80200072 <cprintf>
            cprintf("Supervisor software interrupt\n");
    80200412:	00001517          	auipc	a0,0x1
    80200416:	86650513          	addi	a0,a0,-1946 # 80200c78 <etext+0x202>
    ...
    80200422:	8ca50513          	addi	a0,a0,-1846 # 80200ce8 <etext+0x272>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200462:	87a50513          	addi	a0,a0,-1926 # 80200cd8 <etext+0x262>
...
void exception_handler(struct trapframe *tf) {
    ...
    80200502:	71a50513          	addi	a0,a0,1818 # 80200c18 <etext+0x1a2>
    80200506:	b6dff0ef          	jal	ra,80200072 <cprintf>
	    cprintf("ebreak caught at 0x%016llx\n", tf->epc);	//输出异常指令地址
    8020050a:	10843583          	ld	a1,264(s0)
    8020050e:	00000517          	auipc	a0,0x0
    80200512:	72a50513          	addi	a0,a0,1834 # 80200c38 <etext+0x1c2>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    8020066c:	ba878793          	addi	a5,a5,-1112 # 80201210 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    802006c0:	9c0a0a13          	addi	s4,s4,-1600 # 8020107c <etext+0x606>
    ...
    802006cc:	b10c0c13          	addi	s8,s8,-1264 # 802011d8 <error_string>
    ...
    802007ba:	b0a60613          	addi	a2,a2,-1270 # 802012c0 <error_string+0xe8>
    ...
    8020094e:	96660613          	addi	a2,a2,-1690 # 802012b0 <error_string+0xd8>
    ...
    80200960:	94c60613          	addi	a2,a2,-1716 # 802012a8 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    80200964:	00001417          	auipc	s0,0x1
    80200968:	94540413          	addi	s0,s0,-1723 # 802012a9 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009f4:	8b940413          	addi	s0,s0,-1863 # 802012a9 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
